...
public class Main {
	public static void main(String[] args) {
		...
		//========== Output ============
		//[Field 로 데이터전달]
		// Addition 에 있는 field 의 변수를 이용하여 각각의 클래스에서 method()를 사용해 결과값 리턴
		System.out.println("\n >>> 1.Field를 사용하여 출력합니다. ");
		...
		// Constructor의 파라미터에 숫자를 입력하여 생성되는 순간 출력  
		System.out.println("\n >>> 2.Constructor 를 사용하여 출력합니다.");
		System.out.print("1)3번과 4번의 덧셈, 뺄셈, 곱셈의 결과는 \n ");
		...
		System.out.println("2)1,2,3번의 뺄셈과 곱셈의 결과는 ");
		...
		System.out.println(String.format(
					...
					+ "나눗셈 : %.2f, "
					+ "나머지 : %2d ",
					calc.addAction			(calc.num1,calc.num2,calc.num4),
					calc.subAction			(calc.num1,calc.num2,calc.num4),
					calc.mulAcion 			(calc.num1,calc.num2,calc.num4),
					calc.divAction			(calc.num1,calc.num2,calc.num4),
					calc.remainderAction	(calc.num1,calc.num2,calc.num4)
				));
		System.out.println(String.format(
					  "2) 2번과 4번 의 뺄셈, 나눗셈의 결과는 \n "
					+ "뺄셈 : %d, "
					+ "나눗셈 : %.2f",
